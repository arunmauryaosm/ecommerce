...
import { useProductContext } from "./components/api/productContext";
...
const SingleProduct = () => {
  ...
  const {
    id: alias,
    price, title, image, img1, img2, img3, actualPrice, category
  } = singleProduct;
    ...
    <div>
      ...
      <div className="sm:flex md:my-4 sm:my-2 my-1justify-center">
        ...
        <div className="sm:mt-10 mt-5 sm:w-1/2 p-5">
          ...
          <p className="mt-4 font-semibold text-sm sm:text-xl">Keep your look simple yet stylish by wearing this graceful perky A-line piece designed with embroidery on the surface. The outfit boasts a round neck, three-quarter sleeves, and a curved hemline. Style with a pair of jhumkas and bangles and you are good to go.</p>
          ...
          {/* // button  */}
          <div>
            <Link to='/cart' onClick={() => addToCart(id,  title, img1, price,   singleProduct)}>
